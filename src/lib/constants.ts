...
export const SUPPORTED_HEIC_EXTENSIONS = ["heic", "heif"] as const;
export const SUPPORTED_VIDEO_EXTENSIONS = ["mp4", "mov", "avi", "mkv", "m4v"] as const;
export const SUPPORTED_PDF_EXTENSIONS = ["pdf"] as const;
export const SUPPORTED_PRESENTATION_EXTENSIONS = ["pptx"] as const;
export const SUPPORTED_WORD_EXTENSIONS = ["docx"] as const;
